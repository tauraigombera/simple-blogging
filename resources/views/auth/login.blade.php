    ...
    <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
        <div class="flex justify-center self-center  z-10">
            <div class="px-6 py-6 bg-white mx-auto shadow-2xl rounded-2xl w-100 ">
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <h3 class="font-semibold text-2xl text-gray-800">Welcome back </h3>
                    </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    type="email" name="email" id="email" value="{{old('email')}}" placeholder="mail@gmail.com" required autofocus>
                                @error('email')
                            ...
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    type="password" name="password" id="password" placeholder="Enter your password" required autocomplete="current-password">
                                @error('password')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm">
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="text-orange hover:text-lightOrange">
                            ...
                            <p class="text-center text-gray-500">Don't have an account? <a href="/register" class="text-orange"> Create one</a></p>
                        </div>
                    </form>
