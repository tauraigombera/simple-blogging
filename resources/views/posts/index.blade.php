...
@section('content')
    ...
    @guest
    <section id="hero">
        <div class="container mx-auto flex flex-col-reverse items-center px-6 mt-5 space-y-0 md:space-y-0 md:flex-row">
            <div class="flex flex-col space-y-12 md:w-1/2">
                ...
                <div class="flex justify-center md:justify-start">
                    <a href="/register" class="p-3 px-6 pt-2 text-white bg-orange rounded baseline hover:bg-lightOrange">Start reading</a>
                </div>
            </div>
            <div class="md:w-1/2">
                                    ...
                                    <div class="flex items-center space-x-6">
                                        <div class="space-y-1">
                                            ...
                                            <div class="flex space-x-3">
                                                ...
                                                <a href="/categories/{{ $post->category->slug }}" class="hidden px-1 text-lightGray bg-middleLightGray rounded hover:bg-veryLightGray md:flex">
                                                    {{$post->category->name}}
                                                </a>

                                            </div>
                                        </div>
                                        <img src="/images/post-image-2.jpg" class="rounded-lg h-32 w-48 object-cover" alt="hero-image">
                                    </div>
                                @endforeach
                        </div>
                    </section>
